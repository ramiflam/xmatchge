...
class PHPExcel_IOFactory
{
	...
	private static $_searchLocations = array(
		array( 'type' => 'IWriter', 'path' => 'uploads/PHPExcel_1.8.0_doc/Classes/PHPExcel/Writer/{0}.php', 'class' => 'PHPExcel_Writer_{0}' ),
		array( 'type' => 'IReader', 'path' => 'uploads/PHPExcel_1.8.0_doc/Classes/PHPExcel/Reader/{0}.php', 'class' => 'PHPExcel_Reader_{0}' )
	);
