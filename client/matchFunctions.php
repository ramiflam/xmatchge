...
echo $bullQuery;
         ...
         $num = mysqli_num_rows($bullsResult );
            $bullsCount = $bullsResult->num_rows;
             echo "<br>the num isss".$bullsCount.$num."<br>";
}
        ...
        //echo "<br>sensitivitythe current cow ".$vrsCurrentCow."the bull row is ".$bullRow[bull_no];
 /****
...
echo "milk 3".$dKGMilk;
         ...
         $dFertility = 0;
      	...
      	echo"2<br>dFertility :".$dFertility ;
      	}
      	if ($dFertility <> 0) {
      	echo "<br>yesssssssss".$bullRow['Fertility'];echo "<br>yesssssssssbull no is:".$bullRow['bull_no'];
