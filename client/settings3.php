...
<form  name="set"  method="post"  action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ; ?>" user_id="<?php echo $username?>" farm="<?php echo $userfarm?>" >
    ...
    <div>
        ...
        <li>
            <?php echo $set4_name ?>
            <input type="text" id="set4_inputname" name="name" value="<?php echo $userfarm?>" required pattern="[A-Za-z0-9]{1,}" disabled><br>
        </li>
    <li>
    ...
    <li>
<input type="checkbox" id="day1" name="dayinsemupdate" <?php if( $row["DailyInseminationUpdate"]=='Yes' ) echo checked ?>><label style="margin-right:12px" for="day1"><span></span><?php echo $set4_daily ?></label>
