...
<input type="checkbox" id="juris5" <?php if( $row["Match_judgment_general_legs"]==1 ) echo checked ?>  name="legs"/><label for="juris5"><span></span><?php echo $set2_juris5 ?></label><br>
        ...
        <td id="second">
          ...
          <div  id="reproduc" name="" ><label id="reproduc"><?php echo $set2_subtitle3 ?></label><br> </div>                                         
            ...
            <div><input type="checkbox" id="manufacture6" name="semenfertility"<?php if( $row["Match_production_semen_fertility"]==1 ) echo  checked ?> ><label for="manufacture6"><span></span><?php echo "Semen Fertility";?></label></div><br>
...
<button class="submit" type="button" name="button" id="updateDB2"><?php echo $set4_backup ?></button> </td>
</div>
 ...
 //function updateDB()
  $('#updateDB2').click( function(){
 	    var data = {
 	    	func : 'updateSetting2',
 	    	user_id:$('.sidebar').attr('user_id'),
 	    	farm:$('.sidebar').attr('farm'),
