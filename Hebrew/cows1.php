...
<h1><?php echo $updatePhrase;?></h1>
        ...
        <td class="secttl">מספר פרה</td>
        <td class="secttl"> burn number </td>
        <td class="secttl"> פגם גנטי </td>
        <td class="secttl" >ECM (kg) </td>
        <td class="secttl">מס.תחלובה </td>
        <td class="secttl">מס.הזרעה</td>
        <td class="secttl" >פעיל?</td>
	 ...
	 $query="SELECT * FROM `local_cows` limit 11";
        }
        else
        {
...
<tr index='<?php echo $i?>'>
<td id="pic" >
     <input type="checkbox" name="checkbox" value="" class="checkbox"><img class="cow_pic" src="/assets/cow.jpg" height="30" width="38">
...
<div class="button">
   <button class="submit" type="button" onClick="history.go(0)" name="submit" value="submit"><?php echo $clearPhrase;?></button>
    ...
    <button class="submit" type="button" id="updateDB">עדכון</button> 
