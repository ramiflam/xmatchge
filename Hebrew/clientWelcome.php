...
<div class="cow">
<img src="/assets/logo_login.jpg"alt="Smlogo" height="70" width="120" style="padding-left:40px;">
<div id="center">
...
<ul>
    ...
    <li>
        <span class=<?php echo $class ;?>><input type="text" name="fname" placeholder="<?php echo $namePhrase; ?>" required ></span>
    </li>
    <br>
<li>
...
<li name="read" class="read2" >
    <input type="checkbox" required checked><label dir="rtl"><?php echo $readPhrase; ?> <a class="check" id="check" href="conditions.php"><?php echo $termsPhrase."."; ?></a> </label>
</li>
<li>
